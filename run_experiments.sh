...
#
# Every run: 1000 iterations, 16,384 characters per iteration (batch x context
...
# Axis 1: context length ("chunking"), batch adjusted so characters/iter is constant
